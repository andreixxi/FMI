...
class Joc:
    ...
    def final(self):
        ...
        rez = (elem_identice(self.matr[0:3]) #linia 1
        or elem_identice(self.matr[3:6])     #linia 2
        or elem_identice(self.matr[6:9])     #linia 3
        or elem_identice(self.matr[0:9:3])   #col 1
        or elem_identice(self.matr[1:9:3])   #col 2
        or elem_identice(self.matr[2:9:3])   #col 3
        or elem_identice(self.matr[0:9:4])   #diag princ
        or elem_identice(self.matr[2:8:2]))  #diag sec
...
#             aux = copy.deepcopy(self.matr) #o lista aux
            aux = list(self.matr)
            if aux[j] == Joc.GOL:
                aux[j] = jucator
