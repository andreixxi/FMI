...
if(galleryImages) {
	...
	galleryImages.forEach(function(image, index) {
		image.onclick = function() {
			...
			newImg.setAttribute("src","file://C:/Users/andrei/Desktop/tehniciweb/images/2/gallery1/images/" + setNewImgUrl);//setNewImgUrl este chiar numele imaginii
...
function changeImg(changeDirection) {
	...
	newImg.setAttribute("src", "file://C:/Users/andrei/Desktop/tehniciweb/images/2/gallery1/images/img" + calcNewImg + ".jpg");
	newImg.setAttribute("id", "current-img");
