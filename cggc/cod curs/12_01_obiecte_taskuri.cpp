...
{
  ProgramId=LoadShaders("12_01_Shader.vert", "12_01_Shader.frag");
...
void RenderFunction(void)
{
 ...
 // variabile uniforme pentru shaderul de varfuri
  ...
  myMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(0.f, 0.f, 190.)) * glm::scale(glm::mat4(1.0f), glm::vec3(0.75, 0.75, 1.0));
  myMatrixLocation = glGetUniformLocation(ProgramId, "myMatrix");
  glUniformMatrix4fv(myMatrixLocation, 1, GL_FALSE, &myMatrix[0][0]);
  glDrawElements(GL_TRIANGLES, 18, GL_UNSIGNED_BYTE, (void*)(42));

  //desenare con 3 
  myMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(0.f, 0.f, 225.));
  myMatrixLocation = glGetUniformLocation(ProgramId, "myMatrix");
  glUniformMatrix4fv(myMatrixLocation, 1, GL_FALSE, &myMatrix[0][0]);
  glDrawElements(GL_TRIANGLES, 18, GL_UNSIGNED_BYTE, (void*)(42));
  ...
  // desenare umbra con 1
    ...
    glDrawElements(GL_TRIANGLES, 18, GL_UNSIGNED_BYTE, (void*)(42));
    //umbra con 2
    myMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(0.f, 0.f, 190.));
    myMatrixLocation = glGetUniformLocation(ProgramId, "myMatrix");
    glUniformMatrix4fv(myMatrixLocation, 1, GL_FALSE, &myMatrix[0][0]);
    glDrawElements(GL_TRIANGLES, 18, GL_UNSIGNED_BYTE, (void*)(42));
    //umbra con 3
