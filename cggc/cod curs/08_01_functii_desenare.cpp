...
void RenderFunction(void)
{
 ...
 //
  ...
  glDrawElements(GL_TRIANGLES, 18, GL_UNSIGNED_INT, 0); // count = 18 specifies the number of elements to be rendered
...
// Utilizarea indicilor
     // Matricea: redimensionare+ alta translatie (pe verticala)
	  ...
	  glUniformMatrix4fv(myMatrixLocation, 1, GL_FALSE,  &myMatrix[0][0]);
	  glDrawElementsBaseVertex(GL_TRIANGLES, 3, GL_UNSIGNED_INT, NULL, 1); //aici se folosesc ultimele 3 vf (incepe de la vf 1, nu 0)
