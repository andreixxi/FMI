...
void RenderFunction(void)
{
 ...
 // variabile uniforme pentru shaderul de varfuri
  ...
  glUniform1i(codColLocation, codCol);
  glLineWidth(2.5);
  glDrawElementsInstanced(GL_LINE_LOOP, 4, GL_UNSIGNED_BYTE, (void*)(18), INSTANCE_COUNT); // contur baza
  glDrawElementsInstanced(GL_LINES, 8, GL_UNSIGNED_BYTE, (void*)(22), INSTANCE_COUNT); // muchii varf-baza
