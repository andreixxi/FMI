...
void CreateVBO(void)
{
  ...
  GLfloat Vertices[] = {
	 ...
	 // punctele din planul z=-50  
	  //coordonate						// culori
	  0.0f, 0.0f, -50.0f, 1.0f,  0.0f, 1.0f, 0.0f,
	 // punctele din planul z=+50  
	 // coordonate                   // culori			
  ...
  GLubyte Indices[ ]={
	  ...
	  3, 4, 0,
	  4, 1, 0,
	  1, 2, 3, 4, // muchii baza (contur baza)
	  1, 0,
	  2, 0,
	  3, 0,
	  4, 0
...
void RenderFunction(void)
{
 ...
 // variabile uniforme pentru shaderul de varfuri
  ...
  glUniform1i(codColLocation, codCol);
  glLineWidth(3.5);
  glDrawElements(GL_LINE_LOOP, 3, GL_UNSIGNED_BYTE, (void*)(18)); // 2 muchii de la varf la baza
  glDrawElements(GL_LINE_LOOP, 3, GL_UNSIGNED_BYTE, (void*)(21)); // alte 2 muchii de la vf la baza
  glDrawElements(GL_LINE_LOOP, 4, GL_UNSIGNED_BYTE, (void*)(24)); // muchii baza
...
int main(int argc, char* argv[])
{
  ...
  glutCreateWindow("Desenarea unei piramide folosind testul de adancime"); 
  glewInit(); 
  Initialize( );
